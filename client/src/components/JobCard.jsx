    ...
    return (
        <div className='border p-6 shadow rounded'>
            ...
            <div className='flex items-center gap-3 mt-2 text-xs'>
                <span className='bg-blue-50 border-blue-900 px-4 py-1.5 rounded'>{job.location}</span>
                <span className='bg-red-50 border-red-900 px-4 py-1.5 rounded'>{job.level}</span>
            </div>
